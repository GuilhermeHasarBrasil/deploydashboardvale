    ...
    return (
        <>
            <ul id="furos-list" style={{ display: 'flex', flexDirection: 'column', overflowX: 'auto', overflow: 'hidden' }} >
                <li style={{ marginLeft: 80, marginRight: 80, marginTop: 15, }}>
                    <div style={{ display: 'flex', flexDirection: 'row' }} >
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 120, backgroundColor: '#d9d9d9', }}>
            ...
            <ul id="furos-list" style={{ display: 'flex', flexDirection: 'column', overflowX: 'auto', overflow: 'hidden' }} >
                {furos.map((furo) => (
                    <li style={{ marginLeft: 80, marginRight: 80, }} key={furo.id}>
                        {furo.title}{" "}
                        <div style={{ display: 'flex', flexDirection: 'row' }} >
                            <h1 style={{ color: 'black', width: 120, backgroundColor: '#d9d9d9', height: '100%', fontSize: 16 }} onClick={() => console.log(furo.numero)} >{furo.numero}</h1>
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 120, marginLeft: 5, backgroundColor: '#fff', }} >
